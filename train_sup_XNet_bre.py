...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_dataset', default='dataset/Bre')
    parser.add_argument('--dataset_name', default='Bre', help='CREMI, ISIC-2017, JIA, Bre, GlaS')
    ...
    parser.add_argument('--visdom_port', default=8097, help='8097')
