...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path_model', default='/data/wuqiwei/XNet-main/checkpoints/sup_xnet/GlaS/RGHPA_SUP_xnet-l=0.5-e=200-s=50-g=0.5-b=2-cw=5-w=20-100-L-H/best_Jc_0.8492.pth')
    parser.add_argument('--path_seg_results', default='seg_pred/sup_xnet')
    parser.add_argument('--dataset_name', default='GlaS', help='CREMI, ISIC-2017, GlaS, JIA, Bre')
