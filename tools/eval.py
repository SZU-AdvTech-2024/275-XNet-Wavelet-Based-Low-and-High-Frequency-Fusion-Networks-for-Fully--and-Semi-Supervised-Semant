...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_path', default='/data/wuqiwei/XNet-main/seg_pred/sup_xnet/GlaS/gai_sup_best_Jc_0.8492/')
    parser.add_argument('--mask_path', default='/data/wuqiwei/XNet-main/dataset/GlaS/val/mask/')
